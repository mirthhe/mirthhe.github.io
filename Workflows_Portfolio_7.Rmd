...
So far I have been working with R, BASH, HTML and CSS. Another important language to understand is SQL. With this assignment I'll focus on learning the basics of SQL and applying it to relational data. To start, the dataframes will be created, using the files provided in the assignment, and tidied up.
